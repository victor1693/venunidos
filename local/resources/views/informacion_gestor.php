            ...
            <div class="col-xs-12 sp " style="margin: 0 auto;">
                ...
                <div class="col-sm-8 col-lg-6 sp" style="padding-top: 19px;padding-left: 20px;">
                    ...
                    <div class="text-right">
                        <buttom id="publicar_noticia" onClick="publicar_noticia('articulo')" class="btn btn-xs btn-primary " href="" style="margin-top: 5px;" target="_blank">
                            Publicar
                        </buttom>
                    </div>
                        ...
                        <div class="box-header with-border">
                            ...
                            <div class="box-tools">
                                <button class="btn btn-box-tool" type="button">
                                    <a href="articulo/'.$key->url.'"><i class="fa fa-eye">
                                    </i></a>
                                </button>
                                <button onClick="status_articulos('.$key->id.','. $estado.')" class="btn btn-box-tool" type="button">
                                    <i class="fa fa-pause">
                                    </i>
                                </button>
                                <button class="btn btn-box-tool" type="button">
                                ...
                                <button onClick="status_articulos('.$key->id.',3)" class="btn btn-box-tool" type="button">
