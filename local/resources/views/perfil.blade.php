    ...
    <?php include('local/resources/views/includes/fondo_img.php');?>
        ...
        <div class="contenido" style="margin-top: 101px;">
            <div class="col-xs-12 sp " style="margin: 0 auto;">
                ...
                <div class="col-sm-4 col-lg-2 sp" style="padding-top: 20px;">
                    <div class="col-md-12 sp">
                        <!-- Profile Image -->
                        <div class="box box-primary">
                            <div class="box-body box-profile">
                                <img alt="User profile picture" class="profile-user-img img-responsive img-circle" src="https://avatars.articulate.com/user/avatar/8cbfa0d0-b37e-0131-2ee8-22000b2f96a1/micro_1406930863.png">
                ...
                <div class="col-sm-8 col-lg-6 sp"  style="padding-top: 20px;">
                    <div class="col-md-12">
                        <div class="nav-tabs-custom">
                            <ul class="nav nav-tabs">
                                <li class="">
                                    <a aria-expanded="false" data-toggle="tab" href="#activity">
                                        Activity
                                    </a>
                                </li>
                                <li class="active">
                                    <a aria-expanded="true" data-toggle="tab" href="#timeline">
                                        Timeline
                                    </a>
                                </li>
                                <li class="">
                                ...
                                <div class="tab-pane" id="activity">
                                    ...
                                    <div class="post">
                                        <div class="user-block">
                                            <img class="img-circle img-bordered-sm" src="https://avatars.articulate.com/user/avatar/8cbfa0d0-b37e-0131-2ee8-22000b2f96a1/micro_1406930863.png">
                                                <span class="username">
                                                    <a href="#">
                                                        Jonathan Burke Jr.
                                                    </a>
                                                    <a class="pull-right btn-box-tool" href="#">
                                                        <i class="fa fa-times">
                                                        </i>
                                                    </a>
                                                </span>
                    ...
                    to Charlie Sheen fans.
                                        ...
                                        <form class="form-horizontal">
                                            <div class="form-group margin-bottom-none">
                                                ...
                                                <div class="col-sm-3">
                                                    <button class="btn btn-danger pull-right btn-block btn-sm" type="submit">
                                                        Send
                                                    </button>
                                                </div>
                                            </div>
